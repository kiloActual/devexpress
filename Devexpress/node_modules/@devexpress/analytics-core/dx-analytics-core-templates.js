...
_svgTemplateEngine_1.SvgTemplatesEngine.addTemplates({
    ...
    'dx-combobox-editable': '<div data-bind="dxSelectBox: getOptions({ items: values, value: value, valueExpr: \'value\', displayExpr: \'displayValue\', disabled: disabled, useItemTextAsTitle: true, placeholder: $root.dx._static.selectPlaceholder(), acceptCustomValue: true, onCustomItemCreating: function(arg) { return { value: arg.text, displayValue: arg.text }; }, dropDownOptions: { container: $root.getPopupContainer($element) } })"></div>',
    ...
    'dx-expressioneditor-popup': '<div data-bind="dxPopup: { showTitle: true, wrapperAttr: { class: \'dx-expressioneditor dx-popup-general\' }, title: title(), visible: popupVisible, toolbarItems: buttonItems, showCloseButton: true, fullScreen: false, height: \'600px\', width: \'645px\', container: getPopupContainer($element), position: { of: getPopupContainer($element)}, onShowing: onShowing, onHiding: onHiding, onShown: onShown }"> <!-- ko if: popupVisible --> <!-- ko template: "dx-expressioneditor-main" --> <!-- /ko --> <!-- /ko --> </div>',
