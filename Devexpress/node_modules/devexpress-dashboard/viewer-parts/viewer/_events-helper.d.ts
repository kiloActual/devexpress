...
export declare const createItemClickEventArgs: (dashboardItem: DataDashboardItem, dataPoint: DataPoint, requestUnderlyingDataFunc: any) => ItemClickEventArgs;
...
export declare const createWidgetEventArgs: (dashboardItem: DashboardItem, widget: Element | Widget<any>) => ItemWidgetEventArgs;
