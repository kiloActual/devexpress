...
.dx-dashboard-settings-form .dx-dashboard-settings-form-content {
  ...
  .dx-dashboard-settings-form .dx-dashboard-settings-form-content > div {
    ...
    .dx-dashboard-settings-form .dx-dashboard-settings-form-content > div .dx-dashboard-form-row-caption:not(:first-child) {
      margin-top: 10px; }
    .dx-dashboard-settings-form .dx-dashboard-settings-form-content > div .dx-dashboard-form-row-action-list {
      float: right;
      display: inline-block; }
      .dx-dashboard-settings-form .dx-dashboard-settings-form-content > div .dx-dashboard-form-row-action-list .dx-dashboard-form-row-action {
        display: inline-block;
        color: #9c63ff;
        ...
        font-weight: normal;
        margin-left: 20px; }
        .dx-dashboard-settings-form .dx-dashboard-settings-form-content > div .dx-dashboard-form-row-action-list .dx-dashboard-form-row-action:first-of-type {
          margin-left: 0; }
        .dx-dashboard-settings-form .dx-dashboard-settings-form-content > div .dx-dashboard-form-row-action-list .dx-dashboard-form-row-action.disabled-action {
          color: rgba(245, 246, 247, 0.6);
          cursor: default; }
  ...
  .dx-dashboard-loading-container .dx-dashboard-surface {
    ...
    .dx-dashboard-loading-container .dx-dashboard-surface .dx-layout-item-cover {
      ...
      .dx-dashboard-loading-container .dx-dashboard-surface .dx-layout-item-cover:hover {
        border-color: #9c63ff; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-selected,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-selected, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-selected,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-selected {
      pointer-events: none;
      border-color: #9c63ff; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root.dx-state-underlying-selection .dx-layout-item-cover:not(.dx-layout-selected):not(:hover),
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root.dx-state-underlying-selection .dx-layout-item-cover:not(.dx-layout-selected):not(:hover), body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root.dx-state-underlying-selection .dx-layout-item-cover:not(.dx-layout-selected):not(:hover),
    ...
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root.dx-state-underlying-selection .dx-layout-item-wrapper:not(:hover) > .dx-layout-item-container:not(.dx-layout-item-selected),
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root.dx-state-underlying-selection .dx-layout-item-wrapper:not(:hover) > .dx-layout-item-container:not(.dx-layout-item-selected), body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root.dx-state-underlying-selection .dx-layout-item-wrapper:not(:hover) > .dx-layout-item-container:not(.dx-layout-item-selected),
    ...
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-top,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-top, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-top,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-top {
      ...
      background-color: transparent;
      box-sizing: border-box; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-top,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-top, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-top,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-top {
      background-color: #9c63ff;
      opacity: .1; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-left,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-left, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-left,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-left {
      ...
      background-color: transparent;
      box-sizing: border-box; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-left,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-left, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-left,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-left {
      background-color: #9c63ff;
      opacity: .1; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-right,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-right, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-right,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-right {
      ...
      background-color: transparent;
      box-sizing: border-box; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-right,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-right, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-right,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-right {
      background-color: #9c63ff;
      opacity: .1; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-bottom,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-bottom, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-cover.dx-drag-over-bottom,
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-cover.dx-drag-over-bottom {
      ...
      background-color: transparent;
      box-sizing: border-box; }
    body:hover .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-bottom,
    .dx-dashboard-widget-container .dx-dashboard-surface dashboard-docking-layout.dx-dashboard-in-work .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-bottom, body:hover
    .dx-dashboard-loading-container .dx-dashboard-surface dashboard-docking-layout .dx-layout-root .dx-layout-item-placeholder.dx-drag-over-bottom,
...
.dx-dashboard-item-menu {
  ...
  background-color: #9c63ff;
  overflow: hidden; }
  body:hover dashboard-docking-layout .dx-layout-root .dx-state-selected > .dx-dashboard-item-menu,
  dashboard-docking-layout.dx-dashboard-in-work .dx-state-selected > .dx-dashboard-item-menu {
    opacity: 1;
    visibility: visible; }
...
.dx-dashboard-item-plate {
  ...
  width: 30px;
  height: 16px; }
  body:hover dashboard-docking-layout .dx-layout-root .dx-dashboard-item-plate.dx-state-selected,
  dashboard-docking-layout.dx-dashboard-in-work .dx-dashboard-item-plate.dx-state-selected {
    opacity: 1;
    visibility: visible; }
...
.dx-dashboard-toolbar-extension .dx-dashboard-toolbar-separator {
  ...
  .dx-dashboard-toolbar-extension .dx-dashboard-toolbar-separator .dx-toolbar-item-content {
    ...
    position: absolute;
    height: 100%;
    border-left: 1px solid rgba(158, 158, 197, 0.3); }
