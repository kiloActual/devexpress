...
function createDashboardMultiQueryWizard(requestWrapper, parameters, disableCustomSql, allowCreateNewJsonConnection, wizardSettings, dashboardConnectionStrings) {
    ...
    analytics_wizard_1._registerChooseObjectDataSourceTypesPage(factory, wizardOptions);
    analytics_wizard_1._registerChooseObjectDataSourceDataMembersPage(factory, wizardOptions);
    analytics_wizard_1._registerConfigureObjectDataSourceParametersPage(factory, function () { return new _parameters_item_provider_1.ParametersItemProvider(parameters()); });
