...
var FormatRulePropertiesComposer = (function () {
    ...
    FormatRulePropertiesComposer.prototype.composeTabs = function (model, args) {
        ...
        return [commonTab, conditionTab].concat(additionalTabs, [miscTab]).filter(function (tab) { return !!tab; });
    };
        ...
        switch (model.condition() && model.condition().constructor) {
            case model_1.FormatConditionValue:
                p.push({
                    ...
                    properties: [{
                        ...
                        }, __assign({}, _format_rules_common_1.styleSettings, { formAdapterItem: _form_adapter_editors_1.styleSettingsEditor(simpleStyleSettingsEditorOptions) }), _format_condition_value_1.conditionInCondition,
                    ]
                });
            ...
            case format_condition_top_bottom_1.FormatConditionTopBottom:
                p.push({
                    container: _dashboard_item_format_rule_1.condition,
                    properties: [
                        __assign({}, _format_rules_common_1.styleSettings, { formAdapterItem: _form_adapter_editors_1.styleSettingsEditor(simpleStyleSettingsEditorOptions) }),
            ...
            case model_1.FormatConditionBar:
                p.push({
                    ...
                    properties: [
                        ...
                        __assign({}, _format_condition_bar_1.barCurrentStyleSettings, { formAdapterItem: _form_adapter_editors_1.styleSettingsEditor(barStyleSettingsEditorOptions) }),
                        {
            ...
            case model_1.FormatConditionColorRangeBar:
                p.push({
                    ...
                    properties: [
                        ...
                        __assign({}, _format_condition_range_base_1.rangeSet, { formAdapterItem: _form_adapter_editors_1.ruleRangesEditor({ condition: model.condition(), appearanceMode: barStylesAppearance, enableCustomStyles: true }) }),
                        {
                            container: _format_rules_common_1.barOptions,
                            properties: [
                                _format_condition_bar_options_1.allowNegativeAxis,
            ...
            case model_1.FormatConditionGradientRangeBar:
                p.push({
                    ...
                    properties: [
                        ...
                        __assign({}, _format_condition_range_base_1.rangeSet, { formAdapterItem: _form_adapter_editors_1.ruleRangesEditor({ condition: model.condition(), appearanceMode: gradientStylesAppearance, enableCustomStyles: true }) }),
                        {
                            container: _format_rules_common_1.barOptions,
                            properties: [
                                _format_condition_bar_options_1.allowNegativeAxis,
            ...
            case model_1.FormatConditionRangeSet:
                p.push({
                    ...
                    properties: [
                        _format_condition_range_base_1.rangeValueType,
                        __assign({}, _format_condition_range_base_1.rangeSet, { formAdapterItem: _form_adapter_editors_1.ruleRangesEditor({ condition: model.condition(), appearanceMode: simpleStylesAppearance, enableCustomStyles: isChartItem }) }),
                    ]
                });
                break;
            case undefined:
...
function getCommonCellsFormatRuleProperties(formatRule, getDataItems, getApplyToDataItems) {
    ...
    commonProperties.push(__assign({}, _cells_item_format_rule_1.formatRuleDataItem, { formAdapterItem: _form_adapter_editors_1.dynamicSelectBoxEditor({ values: dataItems }) }));
    commonProperties.push(__assign({}, _cells_item_format_rule_1.dataItemApplyTo, { externalUpdateCallback: externalUpdateCallback, formAdapterItem: _form_adapter_editors_1.dynamicSelectBoxEditor({
