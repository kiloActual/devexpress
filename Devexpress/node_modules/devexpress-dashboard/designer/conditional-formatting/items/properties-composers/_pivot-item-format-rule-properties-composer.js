...
function getMiscFormatRuleProperties(formatRule, pivot, dataSourceBrowser) {
    ...
    properties.push(__assign({}, _pivot_item_format_rule_1.intersectionLevelMode, { formAdapterItem: _form_adapter_editors_1.dynamicSelectBoxEditor({ values: intersectionLevelModeValuesObservable }) }));
    properties.push({
